...
两个 Wayback 快照是不可变归档 → 首次成功后缓存到 ../data/ism_pmi_static.csv,
...
from _common import DATA_DIR, _get, save

STATIC_CACHE = os.path.join(DATA_DIR, "ism_pmi_static.csv")  # 不可变 Wayback 段的本地缓存
